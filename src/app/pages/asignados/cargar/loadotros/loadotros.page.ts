...
@Component({
  selector: 'app-loadotros',
  templateUrl: './loadotros.page.html',
  styleUrls: ['./loadotros.page.scss'],
})
export class LoadotrosPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.hospistal = this.dataService.codHospital
    this.hos = this.dataService.Hospital
  }
  ngAfterViewInit() {
